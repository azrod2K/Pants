            ...
            <div class="row">
                <div class="col-lg-7 offset-lg-4">
                    <div class="banner__item">
                        <div class="banner__item__pic">
                            <img src="assets/img/product/CapturePant9.PNG" alt="">
                        </div>
                        <div class="banner__item__text">
                            <h2>Collection d'hiver Nike</h2>
                            <a href="#">Shop now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="banner__item banner__item--middle">
                        <div class="banner__item__pic">
                            <img src="assets/img/product/CapturePant10.PNG" alt="">
                        </div>
                        <div class="banner__item__text">
                            <h2>Voir la vie en rose</h2>
                            <a href="#">Shop now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="banner__item banner__item--last">
                        <div class="banner__item__pic">
                            <img src="assets/img/product/CapturePant11.PNG" alt="">
                        </div>
                        <div class="banner__item__text">
                            <h2>Pour dehors</h2>
                            <a href="#">Shop now</a>
